...
import com.jordel.projectecafeteria.databinding.FragmentMenjarsBinding

class MenjarsFragment : Fragment() {
    val sharedViewModel: SharedViewModel by activityViewModels()
    val vmMenjar: VMMenjar by activityViewModels()
    ...
    override fun onCreateView(
        ...
        vmMenjar.obtenerProducto(1)?.let {
        ...
        vmMenjar.obtenerProducto(2)?.let {
        ...
        vmMenjar.obtenerProducto(3)?.let {
        ...
        vmMenjar.obtenerProducto(4)?.let {
        ...
        binding.buttonSave.setOnClickListener {
            ...
            val product1 = productesModel(vmMenjar.productes[0].tipus,vmMenjar.productes[0].nom, vmMenjar.productes[0].preu, product1QuantityInt)
            val product2 = productesModel(vmMenjar.productes[1].tipus,vmMenjar.productes[1].nom, vmMenjar.productes[1].preu, product2QuantityInt)
            val product3 = productesModel(vmMenjar.productes[2].tipus,vmMenjar.productes[2].nom, vmMenjar.productes[2].preu, product3QuantityInt)
            val product4 = productesModel(vmMenjar.productes[3].tipus,vmMenjar.productes[3].nom, vmMenjar.productes[3].preu, product4QuantityInt)
